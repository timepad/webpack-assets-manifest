# Webpack Assets Manifest Fork

Этот пакет является форком плагина [Webpack Assets Manifest](https://github.com/webdeveric/webpack-assets-manifest) 
версии 3.0.2. Добавлена возможность работы с `yaml` файлами.
